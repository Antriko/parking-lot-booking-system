...
<template>
    <div class="flex flex-wrap pa3 pa5-l">
        ...
        <div class="w-100 flex flex-wrap" v-else v-for="bookings in data" :key="bookings">
            <div class="w-100 w-100-m w-75-l flex flex-wrap justify-between f3 mt3 pa3 outline grow">
